 ...
 * @return string
 */
function rbld_origin_login_url() {
	return home_url( 'login' );
}

add_filter( 'login_url', 'rbld_origin_login_url' );
 ...
 * @return string
 */
function rbld_origin_forgot_password_url() {
	return home_url( 'forgot-password' );
}

add_filter( 'lostpassword_url', 'rbld_origin_forgot_password_url' );
 ...
 * @return string
 */
function rbld_origin_register_url() {
	return home_url( 'register' );
}

add_filter( 'register_url', 'rbld_origin_register_url' );
 ...
 * @return string
 */
function rbld_origin_rp_message( $message, $key, $user_login ) {
...
add_filter( 'retrieve_password_message', 'rbld_origin_rp_message', 99, 3 );
 ...
 * @return array
 */
function rbld_origin_new_user_message( $wp_new_user_notification_email, $user ) {
...
add_filter( 'wp_new_user_notification_email', 'rbld_origin_new_user_message', 99, 2 );
